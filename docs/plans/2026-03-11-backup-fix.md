...
| Файл | Изменение |
|------|-----------|
| `src/core/backup.py` | Добавить ensure_keensnap_exists(), улучшить логирование |
| `src/core/dns_fix.py` | Создать (или добавить в backup.py) |
| `src/bot3/main.py` | Добавить вызов ensure_dns_works() при запуске |
...
- [ ] Код компилируется (без ошибок импорта)
- [ ] Логирование добавлено в ключевые места
- [ ] Обработка исключений есть
- [ ] Тест на роутере прошёл
