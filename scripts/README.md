...
| Скрипт | Описание |
|--------|----------|
| **bot3/script.sh** | Главный установочный скрипт для bot3 |
| **botlight/script.sh** | Главный установочный скрипт для botlight |
| **KeenSnap/keensnap.sh** | Скрипт создания бэкапов через Telegram бота |
